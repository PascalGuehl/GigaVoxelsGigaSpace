...
The GigaVoxels/GigaSpace core is under the BSD3 license, but the demos and tutorials use various third-party libraries (QT, QGLViewer, ...), some of which have non-BSD license. The most constraining is QGLViewer, with dual license commercial and GPL with lesser exceptions to open source. For this reason we do not put any license on our demos and tutorials files : if you reuse these for your projects, verify the license terms of the libs you pull with them.
