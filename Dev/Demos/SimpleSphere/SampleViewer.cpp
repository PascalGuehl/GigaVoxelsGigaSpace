...
//		// TO DO
//		//
//		// - not yet used, but could be interesting
//		//
...
//		// TO DO
//
//		// - add booleans to activate this or not
//		//
...
//	float4x4* MV = &_sampleCore->_modelViewMatrix;
//	float4x4* P = &_sampleCore->_projectionMatrix;
//	//int4 Viewport;
//	for ( int i = 0; i < 16; i++ )
//	{
//		MV->_array[ i ] = static_cast< float >( modelViewMatrix[ i ] );
//		P->_array[ i ] = static_cast< float >( projectionMatrix[ i ] );
//	}
//
