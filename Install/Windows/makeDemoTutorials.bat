...
cmake -G "Visual Studio 9 2008" ..\..\..\Development\Tutorials\Demos
rem exit
...
cd Demos
rem CMake the application
cmake -G "Visual Studio 9 2008 Win64" ..\..\..\Development\Tutorials\Demos
rem exit
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
...
cd Demos
rem CMake the application
cmake -G "Visual Studio 10" ..\..\..\Development\Tutorials\Demos
rem exit
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
...
cd Demos
rem CMake the application
cmake -G "Visual Studio 10 Win64" ..\..\..\Development\Tutorials\Demos
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
goto :finish
...
cd Demos
rem CMake the application
cmake -G "Visual Studio 11" ..\..\..\Development\Tutorials\Demos
rem exit
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
...
cd Demos
rem CMake the application
cmake -G "Visual Studio 11 Win64" ..\..\..\Development\Tutorials\Demos
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
goto :finish
...
cd Demos
rem CMake the application
cmake -G "Visual Studio 12" ..\..\..\Development\Tutorials\Demos
rem exit
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
...
cd Demos
rem CMake the application
cmake -G "Visual Studio 12 Win64" ..\..\..\Development\Tutorials\Demos
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
goto :finish
