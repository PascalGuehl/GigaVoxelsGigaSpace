...
cmake -G "Visual Studio 9 2008" ..\..\..\Development\Tutorials\ViewerPlugins
rem exit
...
cd ViewerPlugins
rem CMake the application
cmake -G "Visual Studio 9 2008 Win64" ..\..\..\Development\Tutorials\ViewerPlugins
rem exit
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
...
cd ViewerPlugins
rem CMake the application
cmake -G "Visual Studio 10" ..\..\..\Development\Tutorials\ViewerPlugins
rem exit
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
...
cd ViewerPlugins
rem CMake the application
cmake -G "Visual Studio 10 Win64" ..\..\..\Development\Tutorials\ViewerPlugins
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
goto :finish
...
cd ViewerPlugins
rem CMake the application
cmake -G "Visual Studio 11" ..\..\..\Development\Tutorials\ViewerPlugins
rem exit
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
...
cd ViewerPlugins
rem CMake the application
cmake -G "Visual Studio 11 Win64" ..\..\..\Development\Tutorials\ViewerPlugins
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
goto :finish
...
cd ViewerPlugins
rem CMake the application
cmake -G "Visual Studio 12" ..\..\..\Development\Tutorials\ViewerPlugins
rem exit
if NOT ERRORLEVEL 0 pause
cd %CURRENTSCRIPTPATH%
pause
